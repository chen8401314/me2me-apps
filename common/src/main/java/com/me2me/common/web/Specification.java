...
public interface Specification {
    ...
    enum UserRecInitType{
    	...
    	COMMON("COMMON", "无任何条件过滤的"),
    	SEX_FEMALE("SEX_FEMALE", "性别_女"),
    	SEX_MALE("SEX_MALE","性别_男"),
    	AGE_00("AGE_00","年龄段_00后"),
    	AGE_95("AGE_95","年龄段_95后"),
    	AGE_90("AGE_90","年龄段_90后"),
    	AGE_85("AGE_85","年龄段_85后"),
    	AGE_80("AGE_80","年龄段_80后"),
    	AGE_OLD("AGE_OLD","年龄段_活化石"),
    	HOBBY_LVXING("HOBBY_LVXING","兴趣_旅行"),
    	HOBBY_YINYUE("HOBBY_YINYUE","兴趣_音乐"),
    	HOBBY_MEISHI("HOBBY_MEISHI","兴趣_美食"),
    	HOBBY_DONGMAN("HOBBY_DONGMAN","兴趣_动漫"),
    	HOBBY_MEIRONGMEIZHUANG("HOBBY_MEIRONGMEIZHUANG","兴趣_美容美妆"),
    	HOBBY_JIANKANGYANGSHENG("HOBBY_JIANKANGYANGSHENG","兴趣_健康养生"),
    	HOBBY_SHISHANG("HOBBY_SHISHANG","兴趣_时尚"),
    	HOBBY_YOUXI("HOBBY_YOUXI","兴趣_游戏"),
    	HOBBY_SHEJI("HOBBY_SHEJI","兴趣_设计"),
    	HOBBY_SHEYING("HOBBY_SHEYING","兴趣_摄影"),
    	HOBBY_QICHE("HOBBY_QICHE","兴趣_汽车"),
    	HOBBY_YULE("HOBBY_YULE","兴趣_娱乐"),
    	HOBBY_JUNSHI("HOBBY_JUNSHI","兴趣_军事"),
    	HOBBY_LISHI("HOBBY_LISHI","兴趣_历史"),
    	HOBBY_TANSUO("HOBBY_TANSUO","兴趣_探索"),
    	HOBBY_REDIANXINWEN("HOBBY_REDIANXINWEN","兴趣_热点新闻"),
    	HOBBY_QUWEI("HOBBY_QUWEI","兴趣_趣味"),
    	HOBBY_JUJIA("HOBBY_JUJIA","兴趣_居家"),
    	HOBBY_KEJI("HOBBY_KEJI","兴趣_科技"),
    	HOBBY_MEIWEN("HOBBY_MEIWEN","兴趣_美文"),
    	HOBBY_JIAOYU("HOBBY_JIAOYU","兴趣_教育"),
    	HOBBY_JINGGUAN("HOBBY_JINGGUAN","兴趣_经管"),
    	HOBBY_WENHUA("HOBBY_WENHUA","兴趣_文化"),
    	HOBBY_WENTIHUODONG("HOBBY_WENTIHUODONG","兴趣_文体活动"),
    	HOBBY_CHONGWU("HOBBY_CHONGWU","兴趣_宠物"),
    	MBTI_INTJ("MBTI_INTJ","MBTI_INTJ"),
    	MBTI_INTP("MBTI_INTP","MBTI_INTP"),
    	MBTI_ENTJ("MBTI_ENTJ","MBTI_ENTJ"),
    	MBTI_ENTP("MBTI_ENTP","MBTI_ENTP"),
    	MBTI_INFJ("MBTI_INFJ","MBTI_INFJ"),
    	MBTI_INFP("MBTI_INFP","MBTI_INFP"),
    	MBTI_ENFJ("MBTI_ENFJ","MBTI_ENFJ"),
    	MBTI_ENFP("MBTI_ENFP","MBTI_ENFP"),
    	MBTI_ISTJ("MBTI_ISTJ","MBTI_ISTJ"),
    	MBTI_ISFJ("MBTI_ISFJ","MBTI_ISFJ"),
    	MBTI_ESTJ("MBTI_ESTJ","MBTI_ESTJ"),
    	MBTI_ESFJ("MBTI_ESFJ","MBTI_ESFJ"),
    	MBTI_ISTP("MBTI_ISTP","MBTI_ISTP"),
    	MBTI_ISFP("MBTI_ISFP","MBTI_ISFP"),
    	MBTI_ESTP("MBTI_ESTP","MBTI_ESTP"),
    	MBTI_ESFP("MBTI_ESFP","MBTI_ESFP"),
    	EMOTION_CHONGSHI("EMOTION_CHONGSHI","情绪_充实"),
    	EMOTION_CHONGPEI("EMOTION_CHONGPEI","情绪_充沛"),
    	EMOTION_KANGFENG("EMOTION_KANGFENG","情绪_亢奋"),
    	EMOTION_TONGKUAI("EMOTION_TONGKUAI","情绪_痛快"),
    	EMOTION_ZIHAO("EMOTION_ZIHAO","情绪_自豪"),
    	EMOTION_FANGSI("EMOTION_FANGSI","情绪_放肆"),
    	EMOTION_CHAOYUE("EMOTION_CHAOYUE","情绪_超越"),
    	EMOTION_RECHEN("EMOTION_RECHEN","情绪_热忱"),
    	EMOTION_KEWANG("EMOTION_KEWANG","情绪_渴望"),
    	EMOTION_YUKUAI("EMOTION_YUKUAI","情绪_愉快"),
    	EMOTION_ZIZAI("EMOTION_ZIZAI","情绪_自在"),
    	EMOTION_ZIXIN("EMOTION_ZIXIN","情绪_自信"),
    	EMOTION_JINGYANG("EMOTION_JINGYANG","情绪_敬仰"),
    	EMOTION_CHUNCUI("EMOTION_CHUNCUI","情绪_纯粹"),
    	EMOTION_AIMU("EMOTION_AIMU","情绪_爱慕"),
    	EMOTION_ZHUANZHU("EMOTION_ZHUANZHU","情绪_专注"),
    	EMOTION_QIDAI("EMOTION_QIDAI","情绪_期待"),
    	EMOTION_PINGHE("EMOTION_PINGHE","情绪_平和"),
    	EMOTION_XINREN("EMOTION_XINREN","情绪_信任"),
    	EMOTION_HEMU("EMOTION_HEMU","情绪_和睦"),
    	EMOTION_SHIRAN("EMOTION_SHIRAN","情绪_释然"),
    	EMOTION_MANGLU("EMOTION_MANGLU","情绪_忙碌"),
    	EMOTION_XINDONG("EMOTION_XINDONG","情绪_心动"),
    	EMOTION_BUAN("EMOTION_BUAN","情绪_不安"),
    	EMOTION_PINGJING("EMOTION_PINGJING","情绪_平静"),
    	EMOTION_QINSONG("EMOTION_QINSONG","情绪_轻松"),
    	EMOTION_FADAI("EMOTION_FADAI","情绪_发呆"),
    	EMOTION_YOUXIAN("EMOTION_YOUXIAN","情绪_悠闲"),
    	EMOTION_ZHAOJI("EMOTION_ZHAOJI","情绪_着急"),
    	EMOTION_JINZHANG("EMOTION_JINZHANG","情绪_紧张"),
    	EMOTION_YUMEN("EMOTION_YUMEN","情绪_郁闷"),
    	EMOTION_YANJUAN("EMOTION_YANJUAN","情绪_厌倦"),
    	EMOTION_WULIAO("EMOTION_WULIAO","情绪_无聊"),
    	EMOTION_CHOUCHANG("EMOTION_CHOUCHANG","情绪_惆怅"),
    	EMOTION_WUNAI("EMOTION_WUNAI","情绪_无奈"),
    	EMOTION_JIAOLV("EMOTION_JIAOLV","情绪_焦虑"),
    	EMOTION_FANZAO("EMOTION_FANZAO","情绪_烦躁"),
    	EMOTION_EXIN("EMOTION_EXIN","情绪_恶心"),
    	EMOTION_YOULV("EMOTION_YOULV","情绪_忧虑"),
    	EMOTION_HAIPA("EMOTION_HAIPA","情绪_害怕"),
    	EMOTION_SHANGGAN("EMOTION_SHANGGAN","情绪_伤感"),
    	EMOTION_TUIFEI("EMOTION_TUIFEI","情绪_颓废"),
    	EMOTION_KUANGZAO("EMOTION_KUANGZAO","情绪_狂躁"),
    	EMOTION_YANWU("EMOTION_YANWU","情绪_厌恶"),
    	EMOTION_MAMU("EMOTION_MAMU","情绪_麻木"),
    	EMOTION_LENGMO("EMOTION_LENGMO","情绪_冷漠"),
    	EMOTION_KONGJU("EMOTION_KONGJU","情绪_恐惧"),
    	EMOTION_XIEQI("EMOTION_XIEQI","情绪_泄气"),
    	EMOTION_JUEWANG("EMOTION_JUEWANG","情绪_绝望"),
    	CAREER_ZUOYEDANG("CAREER_ZUOYEDANG","职业_作业党"),
    	CAREER_MANONG("CAREER_MANONG","职业_码农"),
    	CAREER_JIALIDUN("CAREER_JIALIDUN","职业_家里蹲"),
    	CAREER_SHOUYIREN("CAREER_SHOUYIREN","职业_手艺人"),
    	CAREER_BADAOZONGCAI("CAREER_BADAOZONGCAI","职业_霸道总裁"),
    	CAREER_BIANJIGOU("CAREER_BIANJIGOU","职业_编辑狗"),
    	CAREER_KAOZUICHIFAN("CAREER_KAOZUICHIFAN","职业_靠嘴吃饭"),
    	CAREER_BAIYITIANSHI("CAREER_BAIYITIANSHI","职业_白衣天使"),
    	CAREER_YUANDING("CAREER_YUANDING","职业_园丁"),
    	CAREER_WEIRENMINFUWU("CAREER_WEIRENMINFUWU","职业_为人民服务")
        ...
        UserRecInitType(String type,String desc){
            this.type = type;
            this.desc = desc;
        }
    }
